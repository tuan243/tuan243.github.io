System.register([], function (_export, _context) {
  ...
  var cc, STATIC_DOMAIN, Application;
    ...
    execute: function () {
      ...
      _export("Application", Application = /*#__PURE__*/function () {
        function Application() {
          ...
          this.settingsPath = STATIC_DOMAIN + 'src/settings.9cf10.json';
          this.showFPS = false;
        }
              ...
              overrideSettings: {
                ...
                assets: {
                  preloadBundles: [{
                    ...
                    bundle: STATIC_DOMAIN + 'assets/main'
                  }, {
                    bundle: STATIC_DOMAIN + 'assets/resources'
                  }]
                },
                profiling: {
